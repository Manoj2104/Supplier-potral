...
export const addPurchaseReturn = (purchase, navigate) => async (dispatch) => {
    ...
    apiConfig
        ...
        .then((response) => {
            ...
            emitPosDataChanged({ type: "purchase_return" });
            dispatch({
...
export const purchaseReturnPdfAction = (id) => async (dispatch) => {
    apiConfig
        .get(`purchase-return-pdf-download/${id}`)
        .then((response) => {
            if (response.data?.data?.purchase_return_pdf_url) {
