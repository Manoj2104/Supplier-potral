...
import { purchaseReturnPdfAction } from "../../store/action/purchaseReturnAction";
import { fetchFrontSetting } from "../../store/action/frontSettingAction";
import TopProgressBar from "../../shared/components/loaders/TopProgressBar";
import FormPageSkeleton from "../../shared/components/skeletons/FormPageSkeleton";
import "../purchase/PurchaseDetailsPremium.css";
...
const PurchaseReturnDetails = (props) => {
    ...
    const attr = purchaseReturnDetails?.attributes 
        || purchaseReturnDetails?.data?.attributes 
        || purchaseReturnDetails 
        || {};
    ...
    const rawItems = attr?.purchase_return_items 
        || attr?.purchase_items 
        || attr?.items 
    ...
    const handlePdfDownload = () => {
        dispatch(purchaseReturnPdfAction(id));
    };
    ...
    return (
        <MasterLayout>
            ...
            {isLoading || !purchaseReturnDetails || !purchaseReturnDetails.reference_code ? (
                <FormPageSkeleton />
            ) : (
                <div className="pur-detail-page">
                    ...
                    <div className="pur-detail-breadcrumb">
                        ...
                        <Link to="/app/purchase-return" className="text-decoration-none text-muted">Purchase Returns</Link>
                        <span className="sep"><FontAwesomeIcon icon={faChevronRight} /></span>
                        <span className="text-dark fw-bold">Purchase Return Details</span>
                    </div>
                    ...
                    <div className="pur-detail-header">
                        <div>
                            <div className="d-flex align-items-center gap-3">
                                <h1 className="pur-detail-header-title">Purchase Return Details</h1>
                            ...
                            <p className="pur-detail-header-subtitle">
                                Reference: <strong className="text-dark">{attr?.reference_code || `PR_${id}`}</strong> &bull; Created on {formattedDate}
                            </p>
                        </div>
                        <div className="d-flex align-items-center gap-2 flex-wrap">
                            <Link to="/app/purchase-return" className="brand-btn-pill" style={{ textDecoration: 'none' }}>
                                <FontAwesomeIcon icon={faArrowLeft} /> Back
                            </Link>
                            <Link to={`/app/purchase-return/edit/${id}`} className="brand-btn-pill" style={{ textDecoration: 'none' }}>
                    ...
                    <div className="pur-detail-info-grid mb-4">
                        ...
                        {/* Column 3: Purchase Return Meta Info */}
                        <div className="pur-detail-info-card">
                            <div className="pur-detail-card-head purple">
                                <div className="pur-detail-col-icon purple">
                                    <FontAwesomeIcon icon={faFileLines} />
                                </div>
                                <span className="pur-detail-head-label">Return Meta</span>
                            </div>
                            <div className="pur-detail-card-body">
                                ...
                                <div className="d-flex align-items-center justify-content-between py-1 border-bottom">
                                    <span className="text-muted fs-small">Return Date:</span>
                            ...
                            <div className="d-flex align-items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p style={{ fontSize: '13px', color: '#64748B', margin: 0 }}>
                                        Configured return products and financial calculations
                                    </p>
                                </div>
                            </div>
                                            ...
                                            {items && items.length > 0 ? (
                                                ...
                                                <tr>
                                                    <td colSpan={8} className="text-center py-5 text-muted">
                                                        ...
                                                        No return items found for this order.
                                                    </td>
                                                </tr>
                                            )}
                                        </tbody>
                    ...
                    <div className="pur-detail-bottom-grid">
                        ...
                        <div className="pur-detail-metric-card">
                            ...
                            <div>
                                ...
                                <div className="pur-detail-metric-val text-success">
                                    {isReceived ? 'Paid / Refunded' : 'Pending'}
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="pur-detail-metric-card">
                            ...
                            <div>
                                <div className="pur-detail-metric-title">Return Method</div>
...
const mapStateToProps = (state) => {
    const { purchaseReturnDetails, frontSetting, allConfigData, isLoading } = state;
    return { purchaseReturnDetails, frontSetting, allConfigData, isLoading };
};
