...
const DEFAULT_SMS_TEMPLATES_CACHE = [
    {
        id: 1,
        attributes: {
...
const SmsTemplates = (props) => {
    const { totalRecord, smsTemplates, fetchSmsTemplates, activeInactiveSms } = props;
    ...
    const safeTemplates = Array.isArray(smsTemplates) && smsTemplates.length > 0
        ? smsTemplates
        : (smsTemplates && Array.isArray(smsTemplates.data) && smsTemplates.data.length > 0
            ? smsTemplates.data
            : (smsTemplates && (smsTemplates.id || smsTemplates.attributes)
                ? [smsTemplates]
                : DEFAULT_SMS_TEMPLATES_CACHE));
        ...
        <MasterLayout>
            ...
            <div className="brand-page-container">
                ...
                <div className="brand-breadcrumb">
                    ...
                    <span>Settings</span>
                    <span>&gt;</span>
                    <span className="brand-crumb-active">SMS Templates</span>
                </div>
                ...
                <div className="brand-header">
                    <div className="brand-title-group">
                        <h1>SMS Templates</h1>
                        <p>Configure automated transactional SMS notifications, customer alerts, and sale reminders.</p>
                    </div>
                    <div className="brand-header-actions">
                        ...
                        >
                            <FontAwesomeIcon icon={faPlus} /> Create SMS Template
                        </Link>
                    </div>
                </div>
                    ...
                    <div className="brand-kpi-grid">
                        ...
                        <div className="brand-kpi-card">
                            <div className="brand-kpi-top">
                                <span className="brand-kpi-label">Total SMS Templates</span>
                        ...
                        <div className="brand-kpi-card">
                            <div className="brand-kpi-top">
                                <span className="brand-kpi-label">SMS Gateway</span>
                    ...
                    <div className="brand-workspace">
                        ...
                        <div className="brand-filter-bar">
                            <div className="brand-search-box">
                                ...
                                <input
                                    type="text"
                                    placeholder="Search SMS template name or content..."
                                    value={searchTerm}
                        ...
                        {filteredTemplates.length === 0 ? (
                            <div style={{ background: '#FFFFFF', borderRadius: '20px', border: '1px solid #EEF2F7', padding: '60px 24px', textAlign: 'center', width: '100%' }}>
                                ...
                                <p style={{ fontSize: '14px', color: '#64748B', maxWidth: '380px', margin: '0 auto 20px auto', lineHeight: 1.5 }}>
                                    All system SMS notification templates will be displayed here
                                </p>
                            </div>
                        ) : viewMode === 'list' ? (
                            /* TABLE VIEW */
