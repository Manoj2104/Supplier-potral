...
class DashboardAPIController extends AppBaseController
{
    ...
    {
        $cacheKey = 'pos_dash_ps_counts_' . date('YmdH') . '_' . floor(date('i') / 2);
    ...
    {
        $cacheKey = 'pos_dash_all_counts_' . date('YmdH') . '_' . floor(date('i') / 2);
        $data = Cache::remember($cacheKey, 30, function () {
    ...
    {
        $cacheKey = 'pos_dash_quick_stats_' . date('YmdH') . '_' . floor(date('i') / 2);
        $data = Cache::remember($cacheKey, 30, function () {
