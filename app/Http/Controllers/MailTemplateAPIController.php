...
class MailTemplateAPIController extends AppBaseController
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(Request $request): MailResource
    {
        $input = $request->all();
        $mailTemplate = MailTemplate::create([
            'template_name' => $input['name'] ?? ($input['template_name'] ?? 'Custom Template'),
    ...
    public function destroy(int $id)
    {
        ...
        return $this->sendSuccess('Email Template deleted successfully');
    }
}
