...
class JioMartAdapter extends AbstractMarketplaceAdapter
{
    protected string $platform = 'JioMart';

    public function detect(string $url): bool
    {
        return str_contains(strtolower($url), 'jiomart.com');
    }
