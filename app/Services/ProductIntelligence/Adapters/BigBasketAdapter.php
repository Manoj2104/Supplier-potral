...
class BigBasketAdapter extends AbstractMarketplaceAdapter
{
    protected string $platform = 'BigBasket';

    public function detect(string $url): bool
    {
        return str_contains(strtolower($url), 'bigbasket.com');
    }
