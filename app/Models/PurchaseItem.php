...
class PurchaseItem extends BaseModel implements JsonResourceful
{
    ...
    public function prepareAttributes(): array
    {
        $fields = [
            ...
            'product_code' => $this->product ? $this->product->code : '',
            'product_name' => $this->product ? $this->product->name : '',
            'product_image' => ($this->product && $this->product->image_url && isset($this->product->image_url['imageUrls'][0])) ? $this->product->image_url['imageUrls'][0] : null,
        ];
