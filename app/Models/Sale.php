...
class Sale extends BaseModel implements HasMedia, JsonResourceful
{
    ...
    public function prepareAttributes(): array
    {
        $fields = [
            ...
            'customer_name' => $this->customer ? $this->customer->name : 'N/A',
            'warehouse_id' => $this->warehouse_id,
            'warehouse_name' => $this->warehouse ? $this->warehouse->name : 'N/A',
            'user_id' => $this->user_id,
            'cashier_name' => $this->user ? ($this->user->first_name . ' ' . $this->user->last_name) : 'Manoj S',
            ...
            'sale_items' => $this->saleItems ? $this->saleItems : [],
