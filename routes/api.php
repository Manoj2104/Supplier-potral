...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('product-stats', [DashboardAPIController::class, 'productStats']);
    Route::get('dashboard-quick-stats', [DashboardAPIController::class, 'quickStats']);
    ...
    // supplier payments
    Route::get('supplier-payments', [\App\Http\Controllers\API\SupplierPaymentAPIController::class, 'index']);
    Route::post('supplier-payments', [\App\Http\Controllers\API\SupplierPaymentAPIController::class, 'store']);
    ...
    //purchase routes
    Route::get('inbound-planning-data', [PurchaseAPIController::class, 'inboundPlanningData']);
    Route::get('inbound-planning-detail/{id}', [PurchaseAPIController::class, 'inboundPlanningDetail']);
    Route::get('validate-receiving-inbound', [PurchaseAPIController::class, 'validateReceivingInbound']);
    Route::post('pda/receiving/generate-grn/{id}', [\App\Http\Controllers\WarehousePdaController::class, 'generateGrn']);
    Route::post('receiving/generate-grn/{id}', [\App\Http\Controllers\WarehousePdaController::class, 'generateGrn']);
    ...
    Route::post('purchases/send-email', [PurchaseAPIController::class, 'sendSupplierMail']);
    ...
    //stock report
    Route::get('inventory/master-stock', [ManageStockAPIController::class, 'masterStock']);
...
// Product extractor & image proxy — no session auth required (Bearer token checked internally)
Route::post('proxy-image', [ProductImageSearchAPIController::class, 'proxyImage']);
Route::post('extract-product-details', [ProductExtractorAPIController::class, 'extract']);
Route::get('pda/dashboard-stats', [\App\Http\Controllers\WarehousePdaController::class, 'apiDashboardStats']);
Route::get('pda/receiving/list', [\App\Http\Controllers\WarehousePdaController::class, 'apiReceivingList']);
Route::get('pda/receiving/details/{id}', [\App\Http\Controllers\WarehousePdaController::class, 'apiReceivingDetails']);
Route::post('pda/receiving/process-scan', [\App\Http\Controllers\WarehousePdaController::class, 'processScan']);
Route::post('pda/receiving/complete-session', [\App\Http\Controllers\WarehousePdaController::class, 'apiCompleteReceiving']);
Route::get('pda/putaway/list', [\App\Http\Controllers\WarehousePdaController::class, 'apiPutawayList']);
Route::post('pda/putaway/complete-session', [\App\Http\Controllers\WarehousePdaController::class, 'apiCompletePutaway']);
Route::get('warehouse-putaway/list', [\App\Http\Controllers\WarehousePdaController::class, 'apiPutawayListWeb']);

// React Super Admin Portal JSON API Endpoints
Route::prefix('saas-admin')->group(function () {
    Route::get('/stats', [\App\Http\Controllers\SuperAdminController::class, 'getDashboardStats']);
    Route::get('/companies', [\App\Http\Controllers\SuperAdminController::class, 'getCompanies']);
    Route::post('/company/action', [\App\Http\Controllers\SuperAdminController::class, 'manageCompanyAction']);
    ...
    Route::get('/override-logs', [\App\Http\Controllers\SuperAdminController::class, 'getOverrideLogs']);
    Route::get('/devices', [\App\Http\Controllers\SuperAdminController::class, 'getDevices']);
    Route::post('/reset-device-binding/{id}', [\App\Http\Controllers\SuperAdminController::class, 'resetDeviceBinding']);
    Route::post('/announcement/create', [\App\Http\Controllers\SuperAdminController::class, 'createAnnouncement']);
    Route::get('/settings', [\App\Http\Controllers\SuperAdminController::class, 'getSettings']);
    Route::post('/settings/update', [\App\Http\Controllers\SuperAdminController::class, 'updateSettings']);
    Route::get('/billing-payments', [\App\Http\Controllers\SuperAdminController::class, 'getBillingPayments']);
    Route::get('/invoices-list', [\App\Http\Controllers\SuperAdminController::class, 'getInvoices']);
    Route::get('/invoice-download/{id}', [\App\Http\Controllers\SuperAdminController::class, 'downloadInvoice']);
    Route::get('/trial-management', [\App\Http\Controllers\SuperAdminController::class, 'getTrialManagement']);
    Route::post('/extend-trial', [\App\Http\Controllers\SuperAdminController::class, 'extendTrial']);
    Route::get('/announcements-list', [\App\Http\Controllers\SuperAdminController::class, 'getAnnouncements']);
    Route::post('/toggle-announcement/{id}', [\App\Http\Controllers\SuperAdminController::class, 'toggleAnnouncement']);
    Route::get('/support-tickets', [\App\Http\Controllers\SuperAdminController::class, 'getSupportTickets']);
    Route::post('/reply-ticket', [\App\Http\Controllers\SuperAdminController::class, 'replySupportTicket']);
    Route::get('/backups-list', [\App\Http\Controllers\SuperAdminController::class, 'getBackupsList']);
    Route::get('/reports-data', [\App\Http\Controllers\SuperAdminController::class, 'getSaasReports']);
});

// Supplier dashboard summary endpoint & fast pulse sync
Route::get('/supplier/dashboard/summary', [\App\Http\Controllers\Supplier\SupplierDashboardController::class, 'summary']);
Route::get('/supplier/shipments/realtime', [\App\Http\Controllers\Supplier\SupplierAsnController::class, 'realtimeApi']);
Route::get('/supplier/invoices/realtime', [\App\Http\Controllers\Supplier\SupplierPurchaseController::class, 'invoicesRealtimeApi']);
Route::post('/supplier/invoices/create', [\App\Http\Controllers\Supplier\SupplierPurchaseController::class, 'createInvoice']);
Route::post('/supplier/asn/{id}/update-status', [\App\Http\Controllers\Supplier\SupplierAsnController::class, 'updateStatus']);



// Fallback direct routes for supplier payments API
Route::get('supplier-payments', [\App\Http\Controllers\API\SupplierPaymentAPIController::class, 'index']);
Route::post('supplier-payments', [\App\Http\Controllers\API\SupplierPaymentAPIController::class, 'store']);
Route::get('supplier-payments/export-bank-cms', [\App\Http\Controllers\API\SupplierPaymentAPIController::class, 'exportBankCms']);
Route::post('supplier-payments/bulk-process', [\App\Http\Controllers\API\SupplierPaymentAPIController::class, 'bulkProcess']);
Route::post('supplier-payments/import-bank-utr', [\App\Http\Controllers\API\SupplierPaymentAPIController::class, 'importBankUtr']);
Route::post('supplier-payments/{id}/repay', [\App\Http\Controllers\API\SupplierPaymentAPIController::class, 'repay']);
Route::delete('supplier-payments/{id}', [\App\Http\Controllers\API\SupplierPaymentAPIController::class, 'destroy']);
